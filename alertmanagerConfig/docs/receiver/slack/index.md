...
* [`fn withLinkNames(value=true)`](#fn-withlinknames)
...
* [`fn withShortFields(value=true)`](#fn-withshortfields)
...
```jsonnet
commonActions.withDashboardButton(icon=":grafana:")
```
...
```jsonnet
commonActions.withLogsButton(icon=":lokii:")
```
...
```jsonnet
commonActions.withRunbookButton(icon=":green_book:")
```

PARAMETERS:

* **icon** (`string`)
   - default value: `":green_book:"`

`withRunbookButton` adds a runbook button.
#### fn commonActions.withSilenceButton

```jsonnet
commonActions.withSilenceButton(icon=":no_bell:")
```

PARAMETERS:

* **icon** (`string`)
   - default value: `":no_bell:"`

`withSilenceButton` adds a silence button.
#### fn commonActions.withSourceButton

```jsonnet
commonActions.withSourceButton(icon=":information_source:")
```

PARAMETERS:

* **icon** (`string`)
   - default value: `":information_source:"`
